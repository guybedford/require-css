...
define('css/css!?prefix:style/style',[],function(){});

define('css/css!?foo=bar&prefix=.COMPONENT_PREFIX:./component',[],function(){});
define('components/component',['css!?foo=bar&prefix=.COMPONENT_PREFIX:./component'], function() {
  return {component: 'is here'};
});

/* nb css form below implies inline style in js file for automatic injection */
define('app',['css!?prefix:style/style', 'components/component'], function(component) {
  return 'uses the component!';
});


define('css/css!popup',[],function(){});
define('popup',['css!popup'], function() {
